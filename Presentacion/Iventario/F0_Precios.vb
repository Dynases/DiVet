...
#Region "MEtodoso Formulario"
    ...
    Private Sub grprecio_EditingCell(sender As Object, e As EditingCellEventArgs) Handles grprecio.EditingCell
        ...
        If (_fnAccesible() And IsNothing(grprecio.DataSource) = False) Then
            ...
            If (e.Column.Index = grprecio.RootTable.Columns("yfcdprod1").Index) Or (e.Column.Index = grprecio.RootTable.Columns("yfcprod").Index) Then 'Or e.Column.Index = grprecio.RootTable.Columns("73").Index
                e.Cancel = True
            Else
                e.Cancel = False
            End If
...
#End Region
    ...
    Private Sub btExcel_Click(sender As Object, e As EventArgs) Handles btExcel.Click
        ...
        If (P_ExportarExcel(RutaGlobal + "\Reporte\Reporte Precios\")) Then
