...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarAlmacen(tbCodigoOriginal.Text, tbNombre.Text, tbDireccion.Text, tbTelf1.Text, _latitud, _longitud, nameImg)
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If (Modificado = False And nameImage <> "") Then
            res = L_fnModificarAlmacen(tbCodigoOriginal.Text, tbNombre.Text, tbDireccion.Text, tbTelf1.Text, _latitud, _longitud, nameImage)

        Else
            res = L_fnModificarAlmacen(tbCodigoOriginal.Text, tbNombre.Text, tbDireccion.Text, tbTelf1.Text, _latitud, _longitud, nameImg)
