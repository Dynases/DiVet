...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarProducto(tbCodigo.Text, tbCodProd.Text, "", tbDescPro.Text, "", cbgrupo1.Value, cbgrupo2.Value, cbgrupo3.Value, cbgrupo4.Value, cbUMed.Value, cbUniVenta.Value, cbUnidMaxima.Value, tbConversion.Text, IIf(tbStockMinimo.Text = String.Empty, 0, tbStockMinimo.Text), IIf(swEstado.Value = True, 1, 0), nameImg)
        ...
        Else
            ...
            ToastNotification.Show(Me, "El producto no pudo ser insertado".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.TopCenter)
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If (Modificado = False) Then
            res = L_fnModificarProducto(tbCodigo.Text, tbCodProd.Text, "", tbDescPro.Text, "", cbgrupo1.Value, cbgrupo2.Value, cbgrupo3.Value, cbgrupo4.Value, cbUMed.Value, cbUniVenta.Value, cbUnidMaxima.Value, tbConversion.Text, IIf(tbStockMinimo.Text = String.Empty, 0, tbStockMinimo.Text), IIf(swEstado.Value = True, 1, 0), nameImage)
        Else
            res = L_fnModificarProducto(tbCodigo.Text, tbCodProd.Text, "", tbDescPro.Text, "", cbgrupo1.Value, cbgrupo2.Value, cbgrupo3.Value, cbgrupo4.Value, cbUMed.Value, cbUniVenta.Value, cbUnidMaxima.Value, tbConversion.Text, tbStockMinimo.Text, IIf(swEstado.Value = True, 1, 0), nameImg)
        End If
        If res Then
        ...
        Else
            Dim img As Bitmap = New Bitmap(My.Resources.cancel, 50, 50)
            ToastNotification.Show(Me, "EL producto no pudo ser modificado".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.TopCenter)
    ...
    Public Overrides Sub _PMOEliminarRegistro()
        ...
        If (bandera = True) Then
            ...
            Else
                Dim img As Bitmap = New Bitmap(My.Resources.cancel, 50, 50)
                ToastNotification.Show(Me, mensajeError, img, 4000, eToastGlowColor.Red, eToastPosition.TopCenter)
            End If
        End If
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("yfnumi", False, "Código".ToUpper, 50))
        listEstCeldas.Add(New Modelo.Celda("yfcprod", True, "Codigo Producto".ToUpper, 150))
        listEstCeldas.Add(New Modelo.Celda("yfcbarra", False))
        listEstCeldas.Add(New Modelo.Celda("yfcdprod1", True, "Descripcion Producto".ToUpper, 500))
        ...
        listEstCeldas.Add(New Modelo.Celda("grupo1", False, lbgrupo1.Text.Substring(0, lbgrupo1.Text.Length - 1).ToUpper, 150))
        listEstCeldas.Add(New Modelo.Celda("grupo2", False, lbgrupo2.Text.Substring(0, lbgrupo2.Text.Length - 1).ToUpper, 150))
