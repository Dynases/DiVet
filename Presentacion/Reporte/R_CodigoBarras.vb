...
Public Class R_CodigoBarras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_CodigoBarras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CodigoBarras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CodigoBarras = New R_CodigoBarras()
        rpt.Site = Me.Site
        Return rpt
    End Function
