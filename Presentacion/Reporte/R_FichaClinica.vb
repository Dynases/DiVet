...
Public Class R_FichaClinica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FichaClinica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FichaClinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FichaClinica = New R_FichaClinica()
        rpt.Site = Me.Site
        Return rpt
    End Function
