...
Public Class R_MorosidadCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_MorosidadCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_MorosidadCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_MorosidadCredito = New R_MorosidadCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
