...
Public Class R_SaldosPorLinea
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SaldosPorLinea.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SaldosPorLinea
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SaldosPorLinea = New R_SaldosPorLinea()
        rpt.Site = Me.Site
        Return rpt
    End Function
