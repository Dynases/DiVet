...
Public Class R_StockActualLote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_StockActualLote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockActualLote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockActualLote = New R_StockActualLote()
        rpt.Site = Me.Site
        Return rpt
    End Function
