...
Public Class R_StockMinimo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_StockMinimo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockMinimo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockMinimo = New R_StockMinimo()
        rpt.Site = Me.Site
        Return rpt
    End Function
