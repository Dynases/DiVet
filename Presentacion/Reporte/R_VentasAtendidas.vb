...
Public Class R_VentasAtendidas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasAtendidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasAtendidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasAtendidas = New R_VentasAtendidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
